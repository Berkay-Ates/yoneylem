...
class AddInstructorController(QMainWindow):
    ...
    def init_ui_elements(self, data):
        ...
        self.main_page_view.pushButton_update_instructor.clicked.connect(self.on_update_instructor)
        if data is not None:
    ...
    def on_update_instructor(self):
        ...
        print(value)
        self.data_signal_update.emit(value, self.index)
        QMessageBox.information(None, "Success!", "Instructor has been updated successfully!")
